...
localparam WIDTH       = 6;    // was 6 — non-power-of-two avoids MSB truncation
```
...
![Standalone testbench — iverilog compile + vvp pass](ssc1.png)
...
| GTKWave waveform | ✅ All bus transactions match expected timing |
